		...
		<div className="space-y-6">
			<div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
				<div>
					...
					<p className="mt-2 text-muted">Manage drafts and published work.</p>
				</div>
				<Link
					...
					{posts.length ? (
							...
							>
								...
								<div className="min-w-0">
									...
									<p className="mt-1 text-xs text-muted">
										{post.engagement.views} views · {post.engagement.likes}{" "}
								...
								<div className="flex gap-2">
									<Link
										...
										className="rounded-full border px-4 py-2 text-sm font-semibold hover:border-accent hover:text-accent"
									>
										Edit
									</Link>
						...
						<div className="p-12 text-center">
							...
							<p className="mt-2 text-sm text-muted">
								Open the editor and publish your first article.
							</p>
						</div>
					)}
				</div>
