		...
		<div className="rounded-3xl border bg-surface p-5 shadow-sm">
			<div className="mb-6 flex items-center justify-between">
				<div>
					...
					<p className="text-sm text-muted">Last 14 active days</p>
				</div>
			</div>
			{data.length ? (
				...
				<div className="grid h-52 place-items-center rounded-2xl bg-surface-muted text-sm text-muted">
					Views will appear after readers visit your posts.
				</div>
			)}
		</div>
	);
