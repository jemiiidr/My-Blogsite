...
export function PostEditorForm({
	...
	const [cover, setCover] = useState(
		initialPost?.coverImageUrl ?? "/images/posts/story-gradient.svg",
	);
			...
			<section className="min-w-0 space-y-5">
				<div className="rounded-3xl border bg-surface p-5 shadow-sm">
					...
					<textarea
						...
						className="w-full resize-none bg-transparent text-3xl font-semibold tracking-tight outline-none placeholder:text-muted sm:text-5xl"
					/>
				...
				<div className="rounded-3xl border bg-surface p-5 shadow-sm">
					...
					<div className="mt-4 space-y-4">
						<div>
							...
							<textarea
								...
								rows={5}
								placeholder="A concise preview for cards and search."
								className="w-full resize-none rounded-xl border bg-background px-3 py-2.5 text-sm"
							/>
						...
						<div>
							...
							<input
								...
								type="password"
								placeholder="Required only to publish"
								className="w-full rounded-xl border bg-background px-3 py-2.5 text-sm"
							/>
					...
					<div className="mt-5 grid gap-2">
						...
						<FormSubmitButton
							...
							className="border bg-surface text-foreground hover:border-accent"
						>
							Save draft
						</FormSubmitButton>
					</div>
